...
import com.sun.image.codec.jpeg.*;
 ...
 public class ImageCompare {
	...
	protected int debugMode = 1; // 1: textual indication of change, 2: difference of factors

	/* create a runable demo thing. */
	public static void main(String[] args) {
		// Create a compare object specifying the 2 images for comparison.
		ImageCompare ic = new ImageCompare("/Users/massi/Pictures/dart/test1.jpg", "/Users/massi/Pictures/dart/test2.jpg");
		...
		if (!ic.match()) {
			saveJPG(ic.getChangeIndicator(), "/Users/massi/Pictures/dart/changes.jpg");
		}
	}
